...
exports.nexaitxml = async (req, res) => {
  ...
  for (let p = 0; p < totalPage.length; p++) {
    ...
    } else if (totalPage[p].page_name == "projects") {
      page_url = base_url + "/projects";
    } else if (totalPage[p].page_name == "solution") {
      page_url = base_url + "/solution";
    } else if (totalPage[p].page_name == "contact-us") {
      page_url = base_url + "/contact-us";
    } else if (totalPage[p].page_name == "about-us") {
      page_url = base_url + "/about-us";
    } else if (totalPage[p].page_name == "career") {
      page_url = base_url + "/career";
    } else if (totalPage[p].page_name == "terms-conditions") {
      page_url = base_url + "/terms-conditions";
    } else if (totalPage[p].page_name == "privacy-policy") {
      page_url = base_url + "/privacy-policy";
    }
...
exports.view_dashboard = async (req, res) => {
  ...
  let where_brand = { isDeleted: false };
  totalbarnds = await BrandModal.find(where_brand).count();

  let where_category = { isDeleted: false };
  totalcategories = await CategoryModal.find(where_category).count();

  let where_subcategory = { isDeleted: false };
  totalsubcategories = await SubcategoryModal.find(where_subcategory).count();

  let where_products = { isDeleted: false };
  totalproducts = await ProductModal.find(where_products).count();
  
  let where_gallery = { isDeleted: false };
  totalGallery = await GalleryModal.find(where_gallery).count();

  let where_application = { isDeleted: false };
  totalApplication = await ApplicationModal.find(where_application).count();
  ...
  try {
    outputJson = {
      ...
      count_brand: totalbarnds,
      count_category: totalcategories,
      count_subcategory: totalsubcategories,
      count_products: totalproducts,
      count_application: totalApplication,
      count_gallery: totalGallery,
      code: 200,
      status: "Success",
...
exports.addpagedata = async (req, res) => {
  ...
  try {
    ...
    outputJson = {
      code: 200,
      status: "Success",
      message: "PageData Add Successfully",
    };
    res.json(outputJson);
  } catch (error) {
    outputJson = { code: 400, status: "Faild", message: "PageData Add Faild" };
...
exports.add_contact = async (req, res) => {
  ...
  try {
    ...
    body +=
      '<p style="font-family:Helvetica,Arial,sans-serif;color:#4f4f4f;font-size:16px;font-weight:600;line-height:20px;padding:0;margin:0 10px;text-align:left;">Best Regards,</p> ';
    body +=
      '<p style="font-family:Helvetica,Arial,sans-serif;color:#4f4f4f;font-size:16px;font-weight:600;line-height:20px;padding:0;margin:0 10px;text-align:left;">www.nexait.in</p> ';
...
exports.view_page = async (req, res) => {
  ...
  var all_page = await PageModal.aggregate(AllPageggregate);
...
exports.view_homepage = async (req, res) => {
  ...
  outputJson = {
    code: 200,
    status: "Success",
    message: "Home Page List successfully.",
    result: result,
  };
  res.json(outputJson);
};
...
exports.addHomepagedata = async (req, res) => {
  ...
  try {
    ...
    outputJson = {
      code: 200,
      status: "Success",
      message: "Home Page Data Add Successfully",
    };
    res.json(outputJson);
  } catch (error) {
    console.log(error);
    outputJson = {
      code: 400,
      status: "Faild",
      message: "Home Page Data Add Faild",
    };
    res.json(outputJson);
  }
};
...
exports.editHomePagedata = async (req, res) => {
  ...
  try {
    ...
    outputJson = {
      code: 200,
      status: "Success",
      message: "Update Home Page successfully.",
      result: result,
    };
    res.json(outputJson);
  } catch (error) {
...
exports.add_aboutnoticed = async (req, res) => {
  ...
  try {
    ...
    outputJson = {
      code: 200,
      status: "Success",
      message: "About Notice Data Add Successfully",
    };
    res.json(outputJson);
  } catch (error) {
    console.log(error);
    outputJson = {
      code: 400,
      status: "Faild",
      message: "About Notice Data Add Faild",
    };
    res.json(outputJson);
  }
};
...
exports.editAboutNoticedata = async (req, res) => {
  ...
  try {
    ...
    outputJson = {
      code: 200,
      status: "Success",
      message: "Update About Notice successfully.",
      result: result,
    };
    res.json(outputJson);
  } catch (error) {
...
exports.getAboutNoticeWithId = async (req, res) => {
  ...
  outputJson = {
    code: 200,
    status: "Success",
    message: "About Notice successfully.",
    result: result,
  };
  res.json(outputJson);
};
...
exports.getAboutNoticeDetails = async (req, res) => {
  ...
  var all_page = await AboutNoticeModal.aggregate(AllPageggregate);
  ...
  try {
    ...
    outputJson = {
      code: 400,
      status: "Faild",
      message: "View View About Notice Faild",
    };
    res.json(outputJson);
  }
};
...
exports.getpagewithName = async (req, res) => {
  ...
  var all_page = await PageModal.aggregate(Allpageaggregate);
  try {
    outputJson = {
      code: 200,
      status: "Success",
...
exports.viewinfluencer = async (req, res) => {
  ...
  var all_Program = await ProgramModal.aggregate(AllProgramaggregate);
...
exports.add_testimonial = async (req, res) => {
  ...
  try {
    ...
    outputJson = {
      code: 200,
      status: "Success",
      message: "Tesimonial Add Successfully",
    };
    res.json(outputJson);
  } catch (error) {
    outputJson = {
...
exports.getTestimonialWithId = async (req, res) => {
  ...
  outputJson = {
    code: 200,
    status: "Success",
    message: "Testimonial List successfully.",
    result: result,
  };
  res.json(outputJson);
};
...
exports.view_testimonial = async (req, res) => {
  ...
  var show_testimonial = await TestimonialModal.aggregate(Testimonialaggregate);
  try {
    outputJson = {
      code: 200,
      status: "Success",
      message: "View Tesimonial Successfully",
      testimonialData: show_testimonial,
    };
    res.json(outputJson);
  } catch (error) {
    outputJson = {
...
exports.all_contact = async (req, res) => {
  ...
  var all_contact = await ContactModal.aggregate(Allcontactaggregate);
...
exports.deleteprogram = async (req, res) => {
  ...
  try {
    ...
    outputJson = {
      code: 200,
      status: "Success",
      message: "Program Remove successfully.",
    };
    res.json(outputJson);
  } catch (error) {
    res.status(400).json(failAction(error.message));
...
exports.deleteTestimonial = async (req, res) => {
  ...
  try {
    ...
    outputJson = {
      code: 200,
      status: "Success",
      message: "Update Tesimonial successfully.",
      result: result,
    };
    res.json(outputJson);
  } catch (error) {
...
exports.download_file = async (req, res) => {
  ...
  try {
    outputJson = {
      code: 200,
      status: "Success",
      message: "View Download file Successfully",
      result: show_download,
    };
    res.json(outputJson);
  } catch (error) {
...
exports.upload_image = async (req, res) => {
  ...
  //get post value
  var myfilenme = "nexait-" + n + "-" + req.files[0].originalname;
  ...
  mv(req.files[0].path, file, function (err) {
    if (err) {
      res
        .status(400)
        .send({ success: 0, msg: "Error to upload file!", data: { err: err } });
    } else {
